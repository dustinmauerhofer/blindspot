...
@__app_environment_variables_v_3.7 = internal constant [37 x i8] c"a1e46581-0b50-4042-a480-bef8209f40dc\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [26 x i8] c"com.companyname.blindspot\00", align 16
...
@__DSOCacheEntry_name.4 = internal constant [16 x i8] c"libMono.Unix.so\00", align 16
...
@dso_cache = local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	; 3
	%struct.DSOCacheEntry {
		i64 3054689107724884744, ; hash 0x2a646f8f1d325b08, from name: Mono.Unix.so
		i8 0, ; ignore
	...
	; 10
	%struct.DSOCacheEntry {
		i64 6309565785434551330, ; hash 0x579014a6ffc8f422, from name: Mono.Unix
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 19
	%struct.DSOCacheEntry {
		i64 8668444381348478075, ; hash 0x784c803cc981bc7b, from name: libMono.Unix
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 26
	%struct.DSOCacheEntry {
		i64 14450776020571797065, ; hash 0xc88b783a2aea3649, from name: libMono.Unix.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
